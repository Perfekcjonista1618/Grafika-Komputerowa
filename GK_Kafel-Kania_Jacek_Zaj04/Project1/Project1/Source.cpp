...
void GenerateTextures()
{
	...
	GLboolean error = load_targa("blonde_girl_white_skin_6.tga", width, height, format, type, pixels);
	...
	error = load_targa("blonde_girl_white_skin_6.tga", width, height, format, type, pixels);
